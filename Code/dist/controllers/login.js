...
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, access, storedPassword, sessionToken, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 6, , 7]);
                _a = req.body, username = _a.username, password = _a.password;
                return [4 /*yield*/, (0, users_1.getAccessName)(username)];
            case 1:
                access = _b.sent();
                return [4 /*yield*/, (0, users_1.getPasswordbyAccessName)(username)];
            case 2:
                storedPassword = _b.sent();
                if (!(access && storedPassword === password)) return [3 /*break*/, 4];
                sessionToken = crypto_1.default.randomBytes(64).toString('hex');
                // Store the session token in the database
                access.authentication.sessionToken = sessionToken;
                return [4 /*yield*/, access.save()];
            case 3:
                _b.sent();
